...
class AgentState(TypedDict, total=False):
    ...
    Uses append-only reducers for lists to ensure accurate auditability and time-travel.
    """
...
def make_event(node: str, event_type: str, message: str, **metadata: object) -> dict[str, Any]:  # noqa: ANN401
